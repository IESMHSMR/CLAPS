...
- [Introducción](#Introducción)
    - [Objetivos](#Objetivos)
    - [¿Qué es CLAPS?](#¿Qué%20es%20CLAPS?)
    - [¿Cómo funciona?](#¿Cómo%20funciona?)
    - [¿Es para todos?](#¿Es%20para%20todos?)
    - [¿Para quién es?](#¿Para%20quién%20es?) (o a quién va destinado)
- [Conceptos](#Conceptos)
    - [LAPS, SLAPS y CLAPS](#LAPS,%20SLAPS%20y%20CLAPS)
    - [Azure Functions](#Azure%20Functions)
    - [Azure Key Vault](#Azure%20Key%20Vault)
- [Requisitos](#Requisitos)
- [Contenido del repositorio](#Contenido%20del%20repositorio)
...
- [Ampliaciones](#Ampliaciones)
    - [Integridad de datos](#Integridad%20de%20datos)
    - [Seguridad](#Seguridad)
    - [Funcionalidades](#Funcionalidades)
- [Problemas identificados](#Problemas%20identificados)
